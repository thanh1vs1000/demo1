...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{asset('public/frontend/fonts/Linearicons-Free-v1.0.0/icon-font.min.css')}}">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{asset('public/frontend/fonts/elegant-font/html-css/style.css')}}">
    <!--===============================================================================================-->
    ...
    <div class="container-menu-header">
        ...
        <div class="wrap_header">
            ...
            <a href="index.html" class="logo">
                <img src="{{('public/frontend/images/icons/logo.png')}}" alt="IMG-LOGO">
            </a>
            ...
            <div class="header-icons">
                <a href="#" class="header-wrapicon1 dis-block">
                    <img src="{{('public/frontend/images/icons/icon-header-01.png')}}" class="header-icon1" alt="ICON">
                </a>

                <span class="linedivide1"></span>

                <div class="header-wrapicon2">
                    <img src="{{('public/frontend/images/icons/icon-header-02.png')}}" class="header-icon1 js-show-header-dropdown" alt="ICON">
...
<section class="slide1">
    <div class="wrap-slick1">
        <div class="slick1">
            <div class="item-slick1 item1-slick1" style="background-image: url({{('public/frontend/images/master-slide-02.jpg')}});">
            ...
            <div class="item-slick1 item2-slick1" style="background-image: url({{('public/frontend/images/master-slide-03.jpg')}});">
                <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
            ...
            <div class="item-slick1 item3-slick1" style="background-image: url({{('public/frontend/images/master-slide-04.jpg')}});">
                <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
        ...
        <div class="row">
            <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                ...
                <div class="block1 hov-img-zoom pos-relative m-b-30">
                    <img src="{{('public/frontend/images/banner-02.jpg')}}" alt="IMG-BENNER">
                ...
                <!-- block1 -->
                <div class="block1 hov-img-zoom pos-relative m-b-30">
                    <img src="{{('public/frontend/images/banner-05.jpg')}}" alt="IMG-BENNER">
...
<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
    ...
    <div class="t-center p-l-15 p-r-15">
        <a href="#">
            <img class="h-size2" src="{{('public/frontend/images/icons/paypal.png')}}" alt="IMG-PAYPAL">
        </a>

        <a href="#">
            <img class="h-size2" src="{{('public/frontend/images/icons/visa.png')}}" alt="IMG-VISA">
        </a>

        <a href="#">
            <img class="h-size2" src="{{('public/frontend/images/icons/mastercard.png')}}" alt="IMG-MASTERCARD">
        </a>

        <a href="#">
            <img class="h-size2" src="{{('public/frontend/images/icons/express.png')}}" alt="IMG-EXPRESS">
        </a>

        <a href="#">
            <img class="h-size2" src="{{('public/frontend/images/icons/discover.png')}}" alt="IMG-DISCOVER">
        </a>
...
<!--===============================================================================================-->
<script type="text/javascript" src="{{asset('public/frontend/vendor/lightbox2/js/lightbox.min.public/frontend/js')}}"></script>
<!--===============================================================================================-->
<script type="text/javascript" src="{{asset('public/frontend/vendor/sweetalert/sweetalert.min.js')}}"></script>
<script type="text/javascript">
